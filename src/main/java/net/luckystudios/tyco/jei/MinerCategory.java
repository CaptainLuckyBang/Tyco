...
public class MinerCategory implements IRecipeCategory<GeneratingRecipe> {
    public static final RecipeType<GeneratingRecipe> MINER_TYPE =
            RecipeType.create("tyco", "miner", GeneratingRecipe.class);

    private final IDrawable icon;
    private final IDrawable arrow;
    private final IDrawable slot;

    public MinerCategory(IGuiHelper guiHelper) {
        this.icon = guiHelper.createDrawableItemStack(new ItemStack(ModBlocks.MINER.get()));
